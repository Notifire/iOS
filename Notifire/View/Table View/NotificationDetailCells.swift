...
typealias NotificationDetailHeaderConfiguration = CellConfiguration<NotificationDetailHeaderCell, NotificationDetailHeaderCell.DataType>
typealias NotificationDetailTitleBodyConfiguration = CellConfiguration<NotificationDetailTitleBodyCell, NotificationDetailTitleBodyCell.DataType>
typealias NotificationDetailAdditionalTextConfiguration = CellConfiguration<NotificationDetailAdditionalTextCell, NotificationDetailAdditionalTextCell.DataType>
typealias NotificationDetailURLConfiguration = CellConfiguration<NotificationDetailURLCell, NotificationDetailURLCell.DataType>
